...
- (void)viewDidLoad {
    ...
    jz_newVersionView.jz_enterBtnTitle = @"点击这里";
    jz_newVersionView.jz_enterBtnBackColor = [UIColor redColor];
    jz_newVersionView.jz_enterBtnTitleFont = 22;
    jz_newVersionView.jz_enterBtnTitleColor = [UIColor blackColor];
    jz_newVersionView.jz_enterBtnBorderColor = [UIColor greenColor];
